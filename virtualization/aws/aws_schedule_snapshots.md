...

{
    "Policy": {
        ...
        "ExecutionRoleArn": "arn:aws:iam::518797234402:role/service-role/AWSDataLifecycleManagerDefaultRole",
        ...
        "PolicyArn": "arn:aws:dlm:eu-central-1:518797234402:policy/policy-0bc26e7e6083a1111"
    }
}
~~~

## How to create snapshot policy via AWS CLI
* Source: https://docs.aws.amazon.com/cli/latest/reference/dlm/create-lifecycle-policy.html
* Create policy JSON
  ~~~
  {
      "ResourceTypes": [
...
* Run AWS CLI command to create a policy
  ...
  aws dlm create-lifecycle-policy \
      ...
      --state ENABLED \
      --execution-role-arn arn:aws:iam::518797234402:role/service-role/AWSDataLifecycleManagerDefaultRole \
